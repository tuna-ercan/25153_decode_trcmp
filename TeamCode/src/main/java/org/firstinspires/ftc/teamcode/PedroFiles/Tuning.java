...
import static org.firstinspires.ftc.teamcode.PedroFiles.Tuning.changes;
import static org.firstinspires.ftc.teamcode.PedroFiles.Tuning.drawOnlyCurrent;
import static org.firstinspires.ftc.teamcode.PedroFiles.Tuning.draw;
import static org.firstinspires.ftc.teamcode.PedroFiles.Tuning.follower;
import static org.firstinspires.ftc.teamcode.PedroFiles.Tuning.stopRobot;
import static org.firstinspires.ftc.teamcode.PedroFiles.Tuning.telemetryM;
 ...
 * is, when paired with StrafeVelocityTuner, allows FollowerPedroConstants to create a Vector that
 ...
 * reaching the end of the distance, it averages them and prints out the velocity obtained. It is
 * recommended to run this multiple times on a full battery to get the best results. What this does
 * is, when paired with ForwardVelocityTuner, allows FollowerPedroConstants to create a Vector that
 * empirically represents the direction your mecanum wheels actually prefer to go in, allowing for
 * more accurate following.
 *
 * @author Anyi Lin - 10158 Scott's Bots
