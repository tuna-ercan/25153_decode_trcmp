 ...
 */
public class MachinePrepP4Request extends CommandBase
{
     ...
     */
    public MachinePrepP4Request(TheMachineSubsystem machineSubsystem)
    {
    ...
    {
        machineSubsystem.setState(AllStates.MachineStates.PREP_P4);
        isFinished = true;
    }
