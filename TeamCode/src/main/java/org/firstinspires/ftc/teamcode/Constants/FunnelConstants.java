...
public class FunnelConstants {
    ...
    @IgnoreConfigurable
    public static String ServoP = "servoP";
    @IgnoreConfigurable
    ...
    public static double RightPrep = 0.525, MiddlePrep = 0.55, LeftPrep = 0.55, PrePrepPrep = 0.55;

    public static double RightPreFeedPrep = 0.44, MiddlePreFeedPrep = 0.465, LeftPreFeedPrep = 0.465;

    public static double RightHome = 0.395, MiddleHome= 0.41, LeftHome = 0.41, PrePrepHome = 0.41;
