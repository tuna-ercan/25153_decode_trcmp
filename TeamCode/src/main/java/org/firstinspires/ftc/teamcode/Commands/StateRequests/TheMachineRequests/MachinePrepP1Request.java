...
/**
 * Request command to set the Machine subsystem to the PREP_P1 state.
 */
public class MachinePrepP1Request extends CommandBase
{
    ...
    /**
     * Constructor for MachinePrepP1Request.
     * @param machineSubsystem The machine subsystem instance.
     */
    public MachinePrepP1Request(TheMachineSubsystem machineSubsystem)
    {
        this.machineSubsystem = machineSubsystem;
    }

    /**
     * Initializes the request by setting the state to PREP_P1.
     */
    @Override
    public void initialize()
    {
        machineSubsystem.setState(AllStates.MachineStates.PREP_P1);
        isFinished = true;
    }
