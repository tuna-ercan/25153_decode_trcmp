...
/**
 * Request command to set the Machine subsystem to the IDLE state.
 */
public class MachineIdleRequest extends CommandBase
{
    ...
    /**
     * Constructor for MachineIdleRequest.
     * @param machineSubsystem The machine subsystem instance.
     */
    public MachineIdleRequest(TheMachineSubsystem machineSubsystem)
    {
    ...
    {
        machineSubsystem.setState(AllStates.MachineStates.IDLE);
        isFinished = true;
    }
